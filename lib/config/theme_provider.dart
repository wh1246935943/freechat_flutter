...
import './../utils/dd_color_utils.dart';
import './../utils/dd_status_bar_utils.dart';
import './colors.dart';
...
class ThemeProvider extends ChangeNotifier {
  ...
  void setTheme([ThemeMethod themeMode = ThemeMethod.themeLight]) {
    SpCache.save(_appThemeKey, themeMethodValues[themeMode]!);
    notifyListeners();
  }
  ...
  ThemeMode getThemeMode() {
    // final String theme = await SpCache.getString(_appThemeKey) ?? '';
    // switch (theme) {
    //   case _themeLight:
...
class MyThemes {
  static final lightTheme = ThemeData(
    primarySwatch: DDColorUtils.materialColor(KColors.kThemeColor),
  ...
  static getThemeData(Color themeColor, {bool isDarkMode = false}) {
    ...
    return ThemeData(
      primarySwatch: DDColorUtils.materialColor(themeColor),
      ...
      appBarTheme: AppBarTheme(
        systemOverlayStyle: DDStatusBarUtils.getStatusBarStyle(isDark: isDarkMode),
