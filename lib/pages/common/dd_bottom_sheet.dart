...
import './../../utils/dd_screen_utils.dart';
...
class _BottomSheetViewState extends State<BottomSheetView> {
  ...
  _body() {
    ...
    return Container(
      color: bgColor,
      height: bgHeight + DDScreenUtils.bottomSafeHeight,
      child: Column(
        children: <Widget>[
          Container(
            color: bgColor,
          ...
          GestureDetector(
            child: Container(
              padding: EdgeInsets.only(bottom: DDScreenUtils.bottomSafeHeight),
              height: _cellHeight + DDScreenUtils.bottomSafeHeight,
              color: bgColor,
              child: Center(
                child: Text(
                  _cancelText,
