...
class _BaseAppBarState extends State<BaseAppBar> {
  ...
  Widget _appBar() {
    ...
    // 设置的颜色优先级高于暗黑模式
    bgColor = widget.bgColor ?? KColors.kThemeColor;
...
//      icon: Icon(Icons.arrow_back_ios,color: _color),
      icon: ImageIcon(const AssetImage('lib/assets/ic_nav_back_white.png'), color: titleAndIconColor),
      iconSize: 18,
    ...
    return AppBar(
      ...
      systemOverlayStyle: DDStatusBarUtils.getStatusBarStyle(isDark: isDark, brightness: brightness),
