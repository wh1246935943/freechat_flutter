...
class _IndexState extends State<Index> with TickerProviderStateMixin {
  ...
  late final List<NavigationIconView> navigationViews = <NavigationIconView>[
    ...
    NavigationIconView(
        icon: const Icon(Icons.contact_mail), title: '联系人', vsync: this),
    NavigationIconView(
        icon: const Icon(Icons.auto_awesome_sharp), title: '发现', vsync: this),
    NavigationIconView(
        icon: const Icon(Icons.account_circle), title: '我的', vsync: this),
  ];
